...
<article class=" mx-auto w-[1200px] ">
        ...
        <div class="grid grid-cols-2 mt-7">
            ...
            <div class="detail">
                ...
                <div class="flex ">
                    ...
                    <span class="font-semibold text-lg line-through mt-3">3.990.000₫</span>
                </div>
    ...
    <div class="">
        ...
        <p class="text-[14px] leading-[1.8] mb-3"> ${data.content}
        </p>
    </div>
            ...
            <form action="">
                <div class=" khoiy border-solid border-2 border-[#f3f3f3] rounded-lg  ">
                    ...
                    <div class="conten-item text-center ">
                        <button
                            class="inline-flex items-center px-4 py-[10px] border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[green] hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Thêm
                            vào giỏ</button>
                    </div>
                </div>
            </form>
...
() => {
toastr.success(`Them san pham ${data.title} Thanh cong`);
},
);
});
},
