                      ...
                      <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <a href="/admin/news/${post.id}/edit"
                            class="border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[green] inline-flex items-center px-4 py-2">Sửa</a>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <button data-id="${post.id}"
                            class="btn btn-remove border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[green] inline-flex items-center px-4 py-2">Xóa</button>
                        </td>
                      </tr>
