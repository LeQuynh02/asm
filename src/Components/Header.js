...
<div class="header-top flex justify-between mt-[30px] h-[80px] w-[1200px] m-auto">
    <figure class="logo pt-5">
        <a href="/">
            <img class="mt-[-45px]" src="https://incucdep.com/wp-content/uploads/2014/12/logo-thoi-trang.jpg"
                width="150px">
        </a>
    </figure>
    <div>
    ...
    <div class="flex mt-[18px] ml-[-84px] text-center">
        <span class="sm:ml-3">
            <a href="/singup">
                <button type="button"
                    class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[green] hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Đăng
                    nhập </button>
            </a>
        </span>
        <span class="sm:ml-3">
        ...
        <span class="sm:ml-3">
            <a href="/cart">
                <button type="button"
                    class="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[green] hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Giỏ hàng</button>
            </a>
        </span>
    </div>
